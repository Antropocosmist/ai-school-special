# AI School Special — NEAR × AI Course

Private repository for the NEAR × AI course and meetup materials (Noviciado × NEAR, "Meetup of Interoperability").
...
Adapted from the AI-School curriculum (`lessons-eng`). Based on the NEAR × Noviciado meetup brief and the official IronClaw docs (`github.com/nearai/ironclaw`).
